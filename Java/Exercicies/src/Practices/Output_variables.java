...
public class Output_variables {
	public static void main(String[] args) {
		...
		System.out.println(n1);
		System.out.println(n3 + 18);
		//code
		System.out.println(n1);
		
		//#19 Declare two variables boolean and print both
		System.out.println(n1);
		System.out.println(n3 + 19);
		//code
		...
		int q52Number = 100;
		int q52Number2 = 150;
		int q52Charge = q52Number = q52Number2;
		int q52Charge2 = q52Number2 = q52Number;
		System.out.println("Charge: " + q52Charge + "Charge2: " + q52Charge2);
		...
		//#55 Store time in seconds and convert to hours, minutes and seconds
		int q55Seconds = 560;
		int q55Minutes = q55Seconds / 60;
		int q55Hours = q55Seconds / 60;
		System.out.println("Seconds: " + q55Seconds + " Minutes: " + q55Minutes + " q55Hours: " + q55Hours);
		
		//#56 Calc a difference age between two people
		int q56People = 21;
		int q56People2 = 23;
		System.out.println("People: " + q56People + " People 2: " + q56People2 + "Difference: " + (q56People - q56People2));
		
		//#57 Calc a media speed with form
		double q57Time = 14.30d - 10.10d;
		int q57Space = 240 - 0;
		int q57MediaSpeed = q57Space / (int) q57Time;
		System.out.println("Media Speed: " + q57MediaSpeed + "KM");
		...
		//#63 Store a special character with char and print
		char q63Number = '$';
		System.out.println("Value: 10" + q63Number);
		
		//#64 Print a character with value ASCII
		char q64Number = 33;
		System.out.println("Value: " + q64Number);
		
		//#65 Calc total value of a purchase at a discount
		String q65Product1Name = "Tomate";
		String q65Product2Name = "Potato";
		String q65Product3Name = "Carrot";
		String q65Product4Name = "Strawberry";
		double q65Product1 = 10.00;
		double q65Product2 = 12.50;
		double q65Product3 = 5.60;
		double q65Product4 = 2.50;
		char q65Dolar = '$';
		double q65Discount = 10.5;
		System.out.println("---Purchase---");
		System.out.println("Items: ");
		System.out.println("> " + q65Product1Name + " " + q65Dolar + q65Product1 + " X " + 10 + (q65Product1 * 10));
		System.out.println("> " + q65Product2Name + " " + q65Dolar + q65Product2 + " X " + 6 + (q65Product2 * 6));
		System.out.println("> " + q65Product3Name + " " + q65Dolar + q65Product3 + " X " + 9 + (q65Product3 * 9));
		System.out.println("> " + q65Product4Name + " " + q65Dolar + q65Product4 + " X " + 15 + (q65Product4 * 15));
		System.out.println("Discount: " + q65Discount);
		System.out.println("Total: " + ((q65Product1 * 10) + (q65Product2 * 6) + (q65Product3 * 9) + (q65Product4 * 15)) / q65Discount);
		
		//#66 Simulate final value with simply fees
		int q66Capital = 2000;
		int q66Fees = 9;
		int q66Time = 94;
		int q66FeesSimply = q66Capital * q66Fees / 100 * q66Time;
		System.out.println("Capital: " + q66Capital + " Fees: " + q66Fees + " Time: " + q66Time);
		System.out.println(q66FeesSimply);
		
		//#67 Simulate final value with compounds fees
		int q67Capital = 1500;
		int q67Fees = 5/100;
		int q67Time = 2;
		int q67M = q67Capital * (1+q67Fees) ^ q67Time;
		System.out.println(q67M);
		...
		//#70 Declare various variables with a line
		int q70Number = 10, q70Number2 = 200, q70Number3 = 100;
		
		//#71 Make accounts with casting: (int) (double)
				
		//#72 Demonstrate what happens with division per zero with int vs double
		int q72Number = 0;
		double q72Number2 = 0.0;
		System.out.println(q72Number / 1);
		//Error or 0
		System.out.println(q72Number2 / 0);
		//NaN
